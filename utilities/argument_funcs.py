...
def parse_train_args():
    ...
    parser.add_argument("-input_dir", type=str, default="./deans_out", help="Folder of preprocessed and pickled midi files")
    ...
    parser.add_argument("-continue_weights", type=str, default="./saved_models/weights/epoch_0094.pickle", help="Model weights to continue training based on")
    parser.add_argument("-continue_epoch", type=int, default=94, help="Epoch the continue_weights model was at")
    ...
    parser.add_argument("-epochs", type=int, default=200, help="Number of epochs to use")
