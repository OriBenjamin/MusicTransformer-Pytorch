...
def parse_train_args():
    ...
    parser.add_argument("-input_dir", type=str, default="./output", help="Folder of preprocessed and pickled midi files")
    ...
    parser.add_argument("-continue_weights", type=str, default="./saved_models/weights/epoch_0070.pickle", help="Model weights to continue training based on")
    parser.add_argument("-continue_epoch", type=int, default=70, help="Epoch the continue_weights model was at")
    ...
    parser.add_argument("-epochs", type=int, default=120, help="Number of epochs to use")
